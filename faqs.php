...
<!-- Mirrored from html.awaikenthemes.com/proshield/faqs by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Apr 2025 18:11:08 GMT -->
<head>
	<!-- Meta -->
	<meta charset="utf-8">
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="wow fadeInUp" data-cursor="-opaque">Frequently asked questions</h1>
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="page-single-sidebar">
                        ...
                        <div class="page-catagery-list wow fadeInUp">
                            <ul>
                                <li><a href="#general_security">General Security</a></li>
                                <li><a href="#services_and_solutions">Services and Solutions FAQs</a></li>
                                <li><a href="#incident_response">Incident Response</a></li>
                                <li><a href="#cloud_security">Cloud Security</a></li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="page-faqs-catagery">
                        <!-- FAQs section start -->
                        <div class="page-faqs-accordion" id="general_security">
                            <!-- Section Title Start -->
                            <div class="section-title">
                                <h2 class="wow fadeInUp" data-cursor="-opaque">General security</h2>
                            </div>
                            <!-- Section Title End -->
                        ...
                        <!-- FAQs section start -->
                        <div class="page-faqs-accordion" id="services_and_solutions">
                            <!-- Section Title Start -->
                            <div class="section-title">
                                <h2 class="wow fadeInUp" data-cursor="-opaque">Services and solutions FAQs </h2>
                            </div>
                            <!-- Section Title End -->
                        ...
                        <!-- FAQs section start -->
                        <div class="page-faqs-accordion" id="incident_response">
                            <!-- Section Title Start -->
                            <div class="section-title">
                                <h2 class="wow fadeInUp" data-cursor="-opaque">Incident response</h2>
                            </div>
                            <!-- Section Title End -->
                        ...
                        <!-- FAQs section start -->
                        <div class="page-faqs-accordion" id="cloud_security">
                            <!-- Section Title Start -->
                            <div class="section-title">
                                <h2 class="wow fadeInUp" data-cursor="-opaque">Cloud security</h2>
                            </div>
                            <!-- Section Title End -->
